public extension Z3Ast where T == BitVectorSortUnsigned64 {
    ...
    static func & (lhs: Z3Ast, rhs: UInt64) -> Z3Ast {
        return lhs.context.makeBvAnd(lhs, lhs.context.makeUnsignedInteger64Bv(rhs))
    }
    static func & (lhs: UInt64, rhs: Z3Ast) -> Z3Ast {
    ...
    static func == (lhs: UInt64, rhs: Z3Ast) -> Z3Bool {
        let lhsInt = rhs.context.makeUnsignedInteger64Bv(lhs)
        return lhsInt == rhs
    }
    static func == (lhs: Z3Ast, rhs: UInt64) -> Z3Bool {
