public extension Z3BitVector where T == BitVectorSort32 {
    // MARK: - Constants Casting

    static func & (lhs: Z3BitVector, rhs: Int32) -> Z3BitVector {
        return lhs.context.makeBvAnd(lhs, lhs.context.makeIntegerBv(rhs))
    }
    static func & (lhs: Int32, rhs: Z3BitVector) -> Z3BitVector {
    ...
    static func == (lhs: Int32, rhs: Z3BitVector) -> Z3Bool {
        let lhsInt = rhs.context.makeIntegerBv(lhs)
        return lhsInt == rhs
    }
    static func == (lhs: Z3BitVector, rhs: Int32) -> Z3Bool {
