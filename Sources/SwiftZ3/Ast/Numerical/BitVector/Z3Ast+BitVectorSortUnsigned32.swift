public extension Z3Ast where T == BitVectorSortUnsigned32 {
    ...
    static func & (lhs: Z3Ast, rhs: UInt32) -> Z3Ast {
        return lhs.context.makeBvAnd(lhs, lhs.context.makeUnsignedIntegerBv(rhs))
    }
    static func & (lhs: UInt32, rhs: Z3Ast) -> Z3Ast {
    ...
    static func == (lhs: UInt32, rhs: Z3Ast) -> Z3Bool {
        let lhsInt = rhs.context.makeUnsignedIntegerBv(lhs)
        return lhsInt == rhs
    }
    static func == (lhs: Z3Ast, rhs: UInt32) -> Z3Bool {
