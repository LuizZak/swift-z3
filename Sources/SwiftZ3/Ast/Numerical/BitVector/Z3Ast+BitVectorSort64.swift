public extension Z3BitVector where T == BitVectorSort64 {
    // MARK: - Constants Casting

    static func & (lhs: Z3BitVector, rhs: Int64) -> Z3BitVector {
        return lhs.context.makeBvAnd(lhs, lhs.context.makeInteger64Bv(rhs))
    }
    static func & (lhs: Int64, rhs: Z3BitVector) -> Z3BitVector {
    ...
    static func == (lhs: Int64, rhs: Z3BitVector) -> Z3Bool {
        let lhsInt = rhs.context.makeInteger64Bv(lhs)
        return lhsInt == rhs
    }
    static func == (lhs: Z3BitVector, rhs: Int64) -> Z3Bool {
